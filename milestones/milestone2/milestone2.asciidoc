...
Antes de recorrer todo el proceso que adoptaremos para añadir como desarrolladores nuevas Niche Wallets, presentaremos brevemente los diversos componentes que agregaremos para cumplir con este milestone. Tras la presentación continuaremos con un desarrollo más detallado del los procedimientos. + 
